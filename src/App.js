  ...
  return (
      ...
      <div className='container my-3'>
         <Switch>
          ...
          <Route exact path="/" element={<Text heading="Enter the text to analyzer below Uppercase Lowercase Remove extra spaces Word Count Character Count ~ Copy Text ~ Clear Text " mode={mode} showAlert={showAlert} />} />
        </Switch>
      </div>
    </Router>
